...
function getMessage(emailParams){
    return{
        ...
        text: `Hola ${emailParams.customerName}, te enviamos las imagenes de los productos comprados y la factura con el número ${emailParams.orderNro}. Gracias por tu pago`,
